...
def get_admin_attendance(request):
    ...
    try:
        ...
        attendance = get_object_or_404(
            Attendance, id=attendance_date_id, session=session, section=section)
...
def delete_section(request, session_id):
    section = get_object_or_404(Section, id=section_id)
    try:
        section.delete()
        ...
        messages.error(
            request, "There are students assigned to this section. Please move them to another section.")
